...
<body>
	...
	<table border="1">
		...
		<tbody>
			<c:set var="results" value="${searchResult.result }"></c:set>
			<c:set var="pagination" value="${searchResult.pagination }"></c:set>
	...
	<c:if test="${currentPage>1 }">
		<a href="loadStudentsByFields?currentPage=${currentPage-1 }"><spring:message
				code="pre.page" /></a>&nbsp;
		</c:if>
	${currentPage}&nbsp;
